...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    ...
    _applyView() {
      ...
      if (fit !== 'cover' || !g || this.getAttribute('position')) {
        // Non-cover, dimensions not known yet, or an author-set static crop
        // (a `position` attr opts a cover slot into native object-position
        // framing instead of the interactive pan/zoom reframe).
